...
Fetch
```
fetch("https://mygarage.bmwusa.com/bin/mybmw/getRecalls?targetVin=/vin/{VIN}&_=1618181674853", {
  "headers": {
  ...
  "referrer": "https://mygarage.bmwusa.com/",
...
```JavaScript
fetch("https://mygarage.bmwusa.com/bin/api/forward?groupId=LDwJ4ZVsyNQGxmwoQ%2BJRpA%3D%3D&targetURL=%2Fmybmw%2Fresources%2Fvehicleprofile%2FgetvehicleFeatures&vin={VIN}&colorCode=0475&upholsteryCode=LCD1&lineMakeId=1&_=1618182862921", {
  "headers": {
    "accept": "application/json, text/javascript, */*; q=0.01",
    "accept-language": "en",
    "sec-fetch-dest": "empty",
  ...
  "referrer": "https://mygarage.bmwusa.com/vehicle-profile.html",
  "referrerPolicy": "strict-origin-when-cross-origin",
  "body": null,
  "method": "GET",
  "mode": "cors",
